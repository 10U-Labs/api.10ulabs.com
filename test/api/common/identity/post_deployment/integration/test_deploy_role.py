...
def test_deploy_role_holds_the_eight_declared_policies(inline_policy_names: list[str]) -> None:
    assert inline_policy_names == [
        "Functions", "Roles", "Routing", "Schedules", "Self", "Ses", "State", "Storage"
    ]
